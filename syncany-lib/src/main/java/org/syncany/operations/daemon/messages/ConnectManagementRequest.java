...
public class ConnectManagementRequest extends ManagementRequest {
	@Element(name = "options", required = true)	
	private ConnectOperationOptions options;

	public ConnectManagementRequest() {
		// Nothing
	}

	public ConnectManagementRequest(ConnectOperationOptions options) {
		this.options = options;
	}

	public ConnectOperationOptions getOptions() {
		return options;
	}
}

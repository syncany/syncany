...
public class LongRunning2400MBFileScenarioTest {
	private static final Logger logger = Logger.getLogger(LongRunning2400MBFileScenarioTest.class.getSimpleName());
	private static final int SIZE_2500_MB = 2500*1024*1024;
	...
	public void testEmptyFileCreateAndSync() throws Exception {
		...
		clientA.createNewFile("A-large-file.zip", SIZE_2500_MB);

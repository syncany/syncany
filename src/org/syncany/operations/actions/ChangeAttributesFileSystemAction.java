...
public class ChangeAttributesFileSystemAction extends FileSystemAction {
	public ChangeAttributesFileSystemAction(Config config, FileVersion fromFileVersion, FileVersion toFileVersion, Database localDatabase, Database winningDatabase) {
	...
	public String toString() {
		return "ChangeAttributesFileSystemAction [file1=" + fileVersion1 + ", file2=" + fileVersion2 + "]";
	}				
}	

...
public class GcmCompatibleCipherInputStream extends FilterInputStream {
     ...
     */
    public GcmCompatibleCipherInputStream(InputStream is, Cipher c) {
        super(is);
        input = is;
        cipher = c;
    }
     ...
     * @param is the to-be-processed input stream
     */
    protected GcmCompatibleCipherInputStream(InputStream is) {
        super(is);
        input = is;
    ...
    public void close() throws IOException {
        ...
        try {
        	...
        	// Fixed to work with GCM, as per http://cr.openjdk.java.net/~valeriep/8012637/webrev.00/src/share/classes/javax/crypto/CipherInputStream.java.patch
